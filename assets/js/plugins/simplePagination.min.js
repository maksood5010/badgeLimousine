  ...
  var a = {
    init: function (t) {
      ...
      return (
        ...
        this.each(function () {
          n.addClass(s.cssStyle).data("pagination", s), a._draw.call(n);
        }),
        s.onInit(),
        this
      );
    ...
    _draw: function () {
      ...
      if (
        ...
        var i = Math.min(s.edges, n.start);
        for (e = 0; e < i; e++) a._appendItem.call(this, e);
        s.edges < n.start &&
          s.ellipseText &&
          t.append('<span class="ellipse">' + s.ellipseText + "</span>");
      }
      for (e = n.start; e < n.end; e++) a._appendItem.call(this, e);
      if (n.end < s.pages && s.edges > 0)
        for (
          s.pages - s.edges > n.end &&
            s.ellipseText &&
            t.append('<span class="ellipse">' + s.ellipseText + "</span>"),
            e = Math.max(s.pages - s.edges, n.end);
          e < s.pages;
          e++
        )
          a._appendItem.call(this, e);
      s.nextText &&
        a._appendItem.call(this, s.currentPage + 1, {
          text: s.nextText,
          classes: "next",
